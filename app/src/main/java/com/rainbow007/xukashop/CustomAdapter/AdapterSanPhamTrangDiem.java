...
public class AdapterSanPhamTrangDiem extends RecyclerView.Adapter<AdapterSanPhamTrangDiem.ViewHolder> {

    Context context;
    List<SanPham> sanPhams;
    int layout;

    public  AdapterSanPhamTrangDiem(Context context, int layout, List<SanPham> sanPhams) {
    ...
    @Override
    public AdapterSanPhamTrangDiem.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
