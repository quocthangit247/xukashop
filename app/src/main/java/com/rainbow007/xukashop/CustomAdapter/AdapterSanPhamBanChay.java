...
public class AdapterSanPhamBanChay extends RecyclerView.Adapter<AdapterSanPhamBanChay.ViewHolder> {

    Context context;
    List<SanPham> sanPhams;
    int layout;

    public  AdapterSanPhamBanChay(Context context, int layout, List<SanPham> sanPhams) {
    ...
    @Override
    public AdapterSanPhamBanChay.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
