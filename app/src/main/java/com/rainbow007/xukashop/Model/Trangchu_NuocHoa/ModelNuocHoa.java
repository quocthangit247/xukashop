package com.rainbow007.xukashop.Model.Trangchu_NuocHoa;
...
public class ModelNuocHoa {
    ...
    public List<ThuongHieu> LayDanhSachThuongHieuLon() {
        ...
        try {
            ...
            for (int i = 0; i < dem; i++) {
                ...
                Log.d("ModelNuocHoa", thuongHieu.getHinhThuongHieu());
                Log.d("ModelNuocHoa", String.valueOf(thuongHieu.getLuotMua()));
    ...
    public List<SanPham> LaySanPhamNuocHoa() {
        ...
        HashMap<String, String> hsHam = new HashMap<>();
        hsHam.put("ham", "LayDanhSachSanPhamNuocHoa");
